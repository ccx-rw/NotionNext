const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2024-05-28', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.ai-free.club' },
    { title: '点击获取AI最新资讯', url: 'https://blog.ai-free.club/ai/news' }
  ],
  ...
  HEO_SOCIAL_CARD_URL: 'https://github.com/RaveyShare',
